    ...
    , m_settings(settings)
{
    ...
    qInfo() << "[" << timestamp << "] ConnectionDialog::ConnectionDialog - Initializing connection dialog";
    ...
    qInfo() << "[" << timestamp << "] ConnectionDialog::ConnectionDialog - Connection dialog initialized";
}
...
{
    setWindowTitle("QmlNetDebugger - Connect to Server");
    setMinimumWidth(400);
    ...
    auto *connectionGroup = new QGroupBox("Connection Settings", this);
    ...
    auto *recentGroup = new QGroupBox("Recent Connections", this);
    ...
    auto *advancedGroup = new QGroupBox("Advanced Settings", this);
    auto *advancedLayout = new QFormLayout(advancedGroup);
    
    // Use SSE checkbox
    m_useSSECheckBox = new QCheckBox("Use Server-Sent Events", this);
...
bool ConnectionDialog::validateInput()
{
    ...
    if (host.isEmpty()) {
        ...
        QMessageBox::warning(this, "Validation Error", "Please enter a server host.");
        m_hostEdit->setFocus();
        return false;
    }
    ...
    if (m_portSpinBox->value() < 1 || m_portSpinBox->value() > 65535) {
        ...
        QMessageBox::warning(this, "Validation Error", "Please enter a valid port number (1-65535).");
    ...
    if (filename.isEmpty()) {
        ...
        QMessageBox::warning(this, "Validation Error", "Please enter a QML filename.");
